...
const Button = () => {
  return (
    <div className="relative w-full h-full overflow-hidden">
      <button className="relative w-full h-14 px-4 py-2 text-white font-bold text-lg rounded-lg bg-gradient-to-r from-pink-500 via-purple-500 to-blue-800 hover:scale-105 transition-transform duration-300">
        <span>read more</span>
